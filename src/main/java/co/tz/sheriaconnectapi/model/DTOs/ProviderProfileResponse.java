...
public class ProviderProfileResponse {
    ...
    public ProviderProfileResponse(ProviderProfile providerProfile) {
        ...
        this.licenseNumber = providerProfile.getLicenseNumber();
        this.registrationNumber = providerProfile.getRegistrationNumber();
        this.bio = providerProfile.getBio();
        this.verificationStatus = providerProfile.getVerificationStatus();
        this.verificationRejectionReason = providerProfile.getVerificationRejectionReason();
        this.specialties = Set.copyOf(providerProfile.getSpecialties());
        this.regions = new TreeSet<>(providerProfile.getRegions());
        this.languages = new TreeSet<>(providerProfile.getLanguages());
