...
@Service
public class RemoveStoryBookmarkService implements Command<StoryUserActionInput, StoryResponse> {
    ...
    public RemoveStoryBookmarkService(
    ...
    public ResponseEntity<StandardResponse<StoryResponse>> execute(StoryUserActionInput input) {
        ...
        storyBookmarkRepository.deleteByStoryAndUser(story, user);
